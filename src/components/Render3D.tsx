...
export default class Render3D extends Component<Props, State> {
  ...
  render() {
    return (
      <View>
        ...
        <Viro3DObject
          source={require(".\\res\\moon\\Moon2K.obj")}
          resources={[require('.\\res\\moon\\moon.mtl'),
          require('.\\res\\moon\\Bump_2K.png'),
          require('.\\res\\moon\\Diffuse_2K.png')]}
